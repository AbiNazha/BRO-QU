        ...
        <div class="col-5 m-auto " style="top: 10vh;">
            <div class="card-body border rounded-lg" style="background-color: white;">
                <div class="card-title text-center mt-2 mb-4">
                    <h4 class="font-weight-bold border-bottom pb-4">INPUT DATA KANDANG</h4>
                </div>
                ...
                @endif
                <form method="POST" action="{{ route('postdatakandang')}}">
                    @csrf
                    {{-- <div class="form-group row ml-3 mr-3">
                        ...
                        <input type="number" name="jumlah_ayam" value="{{ old('jumlah_ayam')}}" class="form-control form-control-sm {{ $errors->has('jumlah_ayam') ? 'is-invalid' : ''}}"  id="JumlahAyam" placeholder="">
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="input-group input-group-sm col-sm-9">
                        <input type="number" name="usia_ayam" value="{{ old('usia_ayam')}}" class="form-control form-control-sm {{ $errors->has('usia_ayam') ? 'is-invalid' : ''}}" id="UsiaAyam" placeholder="">
                        <div class="input-group-prepend">
