            ...
            <div class="card-body border rounded-lg" style="background-color: white;">
                ...
                <form method="POST" action="{{ route('postdataayam')}}">
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="ayam_produktif" value="" class="form-control form-control-sm {{ $errors->has('ayam_produktif') ? 'is-invalid' : ''}}" id="AyamProduktif" placeholder="">
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="ayam_belum_produktif" value="" class="form-control form-control-sm {{ $errors->has('ayam_belum_produktif') ? 'is-invalid' : ''}}" id="AyamBelumProduktif" placeholder="">
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="ayam_tidak_produktif" value="" class="form-control form-control-sm {{ $errors->has('ayam_tidak_produktif') ? 'is-invalid' : ''}}" id="AyamTidakProduktif" placeholder="">
