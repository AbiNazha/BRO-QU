        ...
        <div class="col-5 m-auto " style="top: 10vh;">
            <div class="card-body border rounded-lg" style="background-color: white;">
                <div class="card-title text-center mt-2 mb-4">
                    <h4 class="font-weight-bold border-bottom pb-4">INPUT DATA PETUGAS</h4>
                </div>
                ...
                <form method="POST" action="{{ route('postdata')}}">
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="nama" value="{{ old('nama')}}" class="form-control form-control-sm {{ $errors->has('nama') ? 'is-invalid' : ''}}"  id="Nama" placeholder="">
                            @if ($errors->has('nama'))
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="username" value="{{ old('username')}}" class="form-control form-control-sm {{ $errors->has('username') ? 'is-invalid' : ''}}" id="Username" placeholder="">
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                            <input type="email" name="email" value="{{ old('email')}}" class="form-control form-control-sm {{ $errors->has('email') ? 'is-invalid' : ''}}" id="Email" placeholder="">
                            @if ($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{$errors->first('email')}}
                                </div>
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="alamat" value="{{ old('alamat')}}" class="form-control form-control-sm {{ $errors->has('alamat') ? 'is-invalid' : ''}}" id="Alamat" placeholder="">
                    ...
                    <div class="form-group row ml-3 mr-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="no_hp" value="{{ old('no_hp')}}" class="form-control form-control-sm {{ $errors->has('no_hp') ? 'is-invalid' : ''}}" id="NoHP" placeholder="">
                             @if ($errors->has('no_hp'))
                                <div class="invalid-feedback">
                                    {{$errors->first('no_hp')}}
                                </div>
